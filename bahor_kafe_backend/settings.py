...
ALLOWED_HOSTS = [
    "https://bahor-kafe-backend-2-oedu.onrender.com",
    "localhost",
    "127.0.0.1"
]
...
CORS_ALLOWED_ORIGINS = [
    "https://bahor_kafe_backend-2.onrender.com",
]
...
STATIC_URL = '/static/'                    # Brauzerga ko‘rsatadigan URL
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')   # collectstatic joyi

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),      # loyihadagi static papka
]
